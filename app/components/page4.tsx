...
export default function Page4() {
  ...
  useEffect(() => {
    function handleScroll() {
      console.log("handlescrollcalled");
    ...
    <>
      ...
      <div className="sticky top-0 h-[100vh] w-[50%] z-20 flex items-center justify-center">
        <div className="absolute inset-0 bg-[#D6E8DC] z-30 flex items-center justify-center p-4.5">
          ...
          {RightBoxPage3(scrollPercentageY)}
        ...
        <div className="h-[100vh] flex flex-col text-white items-center justify-center p-8">
          <div className="w-[400px] ">
            ...
            <p className="text-2xl font-sans leading-relaxed text-[#2a3e40]">
              ...
              these opportunities.{" "}
              <b className="text-4xl">Stop missing conversations that matter. Be part of them—with precision targeting and authentic engagement</b> Partner with
              us to connect your brand to the right audience—authentically and
              at scale.
              
            </p>

            <div className="text-6xl self-end">Break the barrier.</div>
          </div>
        </div>
        ...
        <div className="h-[100vh] flex flex-col text-white items-center justify-center p-8">
          <div className="w-[400px] ">
            ...
            <p className="text-2xl font-sans leading-relaxed text-[#2a3e40]">
              ...
              recommendations, we help
              <b className="text-3xl"> position your brand</b> in meaningful
              conversations.
            </p>
          </div>
        </div>
        <div className="h-[100vh] flex flex-col text-white items-center justify-center p-8">
          <div className="w-[400px] ">
            ...
            <p className="text-2xl font-sans leading-relaxed text-[#2a3e40]">
              ...
              skip and don't like to see. We place your products in meaningful
              conversations.
            </p>
          </div>
        </div>
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="group h-full w-full absolute top-[5%] border-2 rounded-b-[100%]"
          style={{
            height: "75%",
...
function RightBoxPage2(scrollPercentageY: number) {
  return (
    ...
    >
      {/* MessageBody outline */}
      <div className=" w-[70%] h-[90%] relative p-3.5 border-2 rounded-2xl overflow-hidden flex flex-col ">
        {/* Inside messages */}
        <div
          style={
...
function RightBoxPage3(scrollPercentageY: number) {
  return (
    <div
    ...
    >
      <div className="h-[70%] w-[40%] text-7xl text-center bg-amber-300 flex justify-center rounded-tl-2xl rounded-bl-2xl">
        Reddit Ads
      </div>
      <Image
      ...
      <div className="h-[70%] w-[40%] text-6xl bg-red-400 flex gap-[20%] justify-end pr-8 rounded-tr-2xl rounded-br-2xl">
