...
export default function Page5() {
  ...
  async function handleSubmit(){
    ...
    await axios.post('../API/send-mail',{fullname:formData.fullname, email:formData.email, message: formData.message})
    setformData({fullname:"", email:"", message:""})
  }
  return (
    <div className="bg-[#3A3735] text-gray-100 px-8 py-12">
      
      <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-[#D6E8DC] text-gray-900 rounded-lg shadow-lg">
        ...
        >
          ...
          <div className="mt-8">
            ...
            <input
              className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="email"
              placeholder="yourbrand@mail.com"
              required
              name="email"
              onChange={handleChange}
            />
          ...
          <div className="mt-8">
            ...
            <input
              ...
              placeholder="Let's elevate your brand to the next level!🚀"
              required
              type="text"
              name="message"
              onChange={handleChange}
