...
export default function Homepage() {
  return (
    <div className="min-h-screen w-[100svw] h-[100svh] bg-[#3A3735] text-white flex flex-col p-3.5">
      <div className="flex w-full justify-between items-center bg-[#464242c2] rounded-2xl z-[100] ">
        <div className="text-6xl w-full leading-tight flex font-sans font-bold">
        LeadZup
      </div>
      {/* Nave Buttons */}
      ...
      <div className="relative flex w-full h-full">
        <div className="relative w-[100vw] h-[100svh] flex flex-col items-start p-x-[16] pt-2.5">
          ...
          <div className="absolute  right-[-100px] z-20">
            ...
            >
              <div className="flex flex-col font-sans text-black text-2xl  p-8">
                <span>I think,</span>
            ...
            <div
              className="float-x flex justify-center absolute left-[1%] bottom-[1%] items-center backdrop-blur-3xl w-[250px] h-[50px] text-xl rounded-[0px 10px 0px 10px]  z-indx-1 p-rlte zws-bnnr-img "
              style={{
                borderRadius: "5px 5px 5px 5px",
                boxShadow: "2px 2px 2px black",
              }}
            >
              <div className="flex font-sans text-[#000] text-3xl ">
          ...
          {/* Center Attraction */}
          <div className="w-[90%] h-[90%] flex flex-col gap-3.5  bg-[#16282D] rounded-4xl p-[5%] border-2 border-black">
            {/* Below LeadZup */}
            <div className="w-[100%] h-[100%] relative flex rounded-4xl pt-[5%]">
              {/* Left */}
              <div className="">
                <div className="text-[#fff]">
                  <h1 className="text-8xl leading-tight">We</h1>
                  <h1 className="text-8xl leading-tight">Convert</h1>
                  <h1 className="text-8xl leading-tight">Conversation</h1>
                  <h1 className="text-8xl leading-tight">INTO Customers</h1>

                  <p className="font-sans max-w-md text-xl leading-relaxed">
                    Attract the customers not the crowd.
                  </p>
                </div>
                <div className="flex space-x-6 items-center absolute left-0 z-[100]">
                  {/* Social  */}
                  <>
                    <a
                      href="#"
