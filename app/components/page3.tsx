        ...
        <section className="py-24 ">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-4xl font-bold text-white sm:text-5xl mb-8 transition-all duration-300 ">
                       Impact on Business Growth Through words of people
                    </h2>
                    <p className="text-2xl text-white max-w-3xl mx-auto mb-16">
                        Let's talk about numbers.
                    </p>
                    
                    <div className=" flex flex-col md:flex-row  justify-evenly gap-10 mt-12">
                        {/* Market Trust Card */}
                        <div className="bg-[#D6E8DC] basis-0 grow-1 h-[250px]  p-8 text-black rounded-xl shadow-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
                        style={{
