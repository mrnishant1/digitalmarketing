...
const Terms = () => {
  return (
    <div className="p-8 w-[100vw] h-[100vh]   mx-auto text-gray-800 bg-[#FDEAD5]">
      <h1 className="text-3xl font-bold mb-6 text-center">Terms and Conditions</h1>

      <p className="mb-4">
        Welcome to our marketing agency. By engaging our services, you agree to
        the following terms and conditions. Please read them carefully before
        using our services.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">1. Service Disclaimer</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        Due to the nature of digital services, all completed or in-progress work
        is non-refundable. Once a project has started, cancellation requests
        will not be eligible for refunds.
      </p>

      <p className="mb-4">
        Refunds may only be issued in cases of accidental duplicate payments or
        if a service was not delivered due to our error. Approved refunds will
        be processed within 7–10 business days via the original payment method.
      </p>
